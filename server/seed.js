...
const users = [
    { name: 'Sonu', email: 'sonukr@gmail.com', password: 'Sonu@123', role: 'admin' },
    { name: 'Rock', email: 'rock@gmail.com', password: 'Rock@123', role: 'user' },
    { name: 'John', email: 'john1@gmail.com', password: 'John@123', role: 'user' },
    {
    name: 'Priya',
